...
namespace osiris
{
    ...
    private:
         ...
         * @return void
         */
        void loadImage(const std::string &rFilename, Mat *ppImage);
         ...
         * @return void
         */
        void saveImage(const std::string &rFilename, const Mat pImage);
